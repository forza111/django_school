...
def create_question(question_text,days):
    ...
    offset to now (negative for questions published in the last, positive for questions that have
    yet to be published).
    '''
...
class QuestionIndexViewTests(TestCase):
    def test_no_questions(self):
        ...
        '''
        assertEqual check first argument "response.status code" 
        and second argument "200". If the values do not compare equal,
        the test will fail
        '''
        ...
        '''
        assertQuerysetEqual asserts that first argument return
        particular list of values second argument
        '''
